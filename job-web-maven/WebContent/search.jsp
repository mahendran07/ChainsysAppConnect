...
<body>
	...
	<div class="collapse navbar-collapse" id="navbar">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"><a class="nav-link" href="JobServlet">Jobs
	...
	<div class="row">
		<div class="column">
			<c:forEach var="searchList" items="${SEARCHLIST}">
				<div class="row wow fadeIn" id="Search">
					<!--Grid column-->
							...
							<div class="card-body">
								<form method="post" action="ViewCompany">
									<table>
										<tbody>
											<tr>
												<td><h3 id="halign">${searchList.company_name}</h3></td>
											</tr>
											<tr>
												<th>Recruiters Name</th>
												<td>${searchList.recruiters_name}</td>
											<tr>
												<th>Position</th>
												<td>${searchList.position}</td>
											<tr>
												<th>Location</th>
												<td>${searchList.location}</td>
											<tr>
												<th>Vacancy Position</th>
												<td>${searchList.vaccancy_position}</td>
											<tr>
												<th>Skills Required</th>
												<td>${searchList.skill_required}</td>
											<tr>
												<th>Vacancy</th>
												<td>${searchList.vaccancy}</td>
											<tr>
												<td><button type="submit" name="companyname"
														id="viewbtn" value="${searchList.company_name}"
